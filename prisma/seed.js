...
const main = async () => {
  ...
  //// BRAND
    const brandBauer = await prisma.brand.create({
      data: {
        BrandName: 'Bauer',
        avatar: "https://img.inlinewarehouse.com/graphics-resizer/logos/BAUER.svg"
      }
    })
    ...
    const brandWarrior = await prisma.brand.create({
      data: {
        BrandName: 'Warrior',
        avatar: "https://img.inlinewarehouse.com/graphics-resizer/logos/WARRIOR.svg"
      }
    })
    ...
    const brandTrue = await prisma.brand.create({
      data: {
        BrandName: 'True',
        avatar: "https://img.inlinewarehouse.com/graphics-resizer/logos/TRUEHOCKEY.svg"
      }
    })
    ...
    const brandSherwood = await prisma.brand.create({
      data: {
        BrandName: 'Sherwood',
        avatar: "https://img.inlinewarehouse.com/graphics-resizer/logos/SHERWOOD.svg"
      }
    })
